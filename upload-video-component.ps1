# Upload ProductSpinVideo component
...
$scriptFile = Join-Path $env:TEMP "winscp_video_component.txt"
$scriptContent | Out-File -FilePath $scriptFile -Encoding ASCII
& "C:\Program Files (x86)\WinSCP\WinSCP.com" /script=$scriptFile
Remove-Item $scriptFile -Force -ErrorAction SilentlyContinue
Write-Host "ProductSpinVideo component uploaded!" -ForegroundColor Green
