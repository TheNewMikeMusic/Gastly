...
export function TrustStrip() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
        {trustItems.map((item, index) => (
          <motion.div
            ...
            className="glass-card rounded-2xl p-4 sm:p-6 min-h-[168px] shadow-[0_18px_40px_rgba(15,23,42,0.08)]"
          >
